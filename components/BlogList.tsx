    ...
    <div className="bg-[#0D323F] text-[#F7E6C9] min-h-screen font-sans">
      ...
      <main className="container mx-auto px-4 py-12" role="main">
        <header className="text-center mb-16">
          <h1 className="font-display text-5xl sm:text-6xl md:text-8xl text-white">From The Journal</h1>
          <p className="text-lg text-white/80 mt-2">Stories, culinary insights, and news from the Posh Lounge Rooftop.</p>
        </header>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {posts.map((post) => (
            <article key={post.slug} className="bg-[#14424C] rounded-lg overflow-hidden flex flex-col group">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <button
                  ...
                  className="mt-6 self-start flex items-center gap-2 text-[#E1B168] font-bold uppercase tracking-widest text-sm hover:text-amber-300 transition-colors"
                >
                  Read More
